...
public class TerrainShader extends ShaderProgram{
    ...
    private static final String VERTEX_FILE = "src/com/realgotqkura/shader/terrainVertexShader.txt";
    private static final String FRAGMENT_FILE = "src/com/realgotqkura/shader/terrainFragmentShader.txt";
